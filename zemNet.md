...
Complete migration system with 5 migration files:
1. Core tables (users, hotspots, plans, vouchers)
2. Transactions (purchases, sessions)
3. Host features (earnings, payouts, cash-in)
4. Technical support (service requests)
5. Admin features (KYC, system logs)
